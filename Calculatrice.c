...
void soustractionnormale(int res[], int nb1[], int nb2[], int taille){
    int i=0;
    int cur=0;
    for(i=0; i<taille; i++){
...
void addition(int res[], int nb1[], int nb2[], int taille){
    ...
    if (detecter1==1 && detecter2==2){
        conversion(nb2, 1000);
        comparaisontch = comparaison(nb1, nb2, 1000);
        if (comparaisontch==2){
            soustractioncontraire(res, nb1, nb2, 1000);
        }
        else if (comparaisontch==1){
            soustractionnormale(res, nb1, nb2, 1000);
        }
    }
        ...
        comparaisontch = comparaison(nb1, nb2, 1000);
        if (comparaisontch==2){
            soustractionnormale(res, nb2, nb1, 1000);
        }
        else if (comparaisontch==1){
            soustractioncontraire(res, nb2, nb1, 1000);
        }
    }
...
int vidange(int res[], int taille){
    int i;
    int vide[1000]={0};
    int comparaisontch=comparaison(vide, res, 1000);
    for (i=0; i<taille; i++){
        if (comparaisontch==3){
            printf("0");
            return 0;
...
int main(){
    ...
    int i;
    int comparaisontch = comparaison(nb1, nb2, 1000);
    int comparaisontch2 = comparaison(nb2, nb3, 1000);
    // CAS UN SEUL OP
    if (op2=='\n'){
    if (op1=='+'){
